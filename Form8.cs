...
namespace ShopdogV1
{
    public partial class Hestrory_sell_form : Form
    {
        // connect Database 
        ...
        public Hestrory_sell_form(string user)
        {
            InitializeComponent();
            panel1.Tag = user;
            data_into_listview();
        ...
        private void data_into_listview()
        {
            ...
            //image to view1
            String SelectQuery = "SELECT * FROM dog_info WHERE UserName ='" + panel1.Tag + "' AND Sell != 'sell'  ORDER BY id DESC";
